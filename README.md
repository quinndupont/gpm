...
| **Poet REINFORCE** | Planned | Reward-weighted regression: score poems with deterministic algo, Â = (score−μ)/σ, L = −Σ Â·log P. KL penalty to SFT baseline. |
| **Partial credit reward** | Planned | Tiered scoring: perfect 1.0 → slant 0.6 → assonance 0.3 → none 0.0. Avoids forced rhyme at expense of meaning. |
